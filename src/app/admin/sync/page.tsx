...
-- 11. CREATE / ALIGN MAGAZINES & PRINT LAYOUTS TABLE
...
-- RLS & SECURITY FOR MAGAZINES
ALTER TABLE magazines ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Allow public select" ON magazines;
CREATE POLICY "Allow public select" ON magazines FOR SELECT USING (true);
DROP POLICY IF EXISTS "Allow auth all" ON magazines;
CREATE POLICY "Allow auth all" ON magazines FOR ALL TO authenticated USING (true);
  `.trim();
